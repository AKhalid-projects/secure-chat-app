...
> **Note (this fork):** The Secure Chat application lives at the **repository root** ([`README.md`](../README.md)). In the **upstream** CometChat React Native UI Kit repository, additional sample apps appear under `examples/`; those paths are **not** mirrored here.
...
- Sample App, Sample App AI, Sample App with Push Notifications — see the **CometChat UI Kit** source distribution you cloned from (or [CometChat docs](https://www.cometchat.com/docs/ui-kit/react-native/5.0/overview)) for `examples/` sample paths.
- **Secure Chat App (Expo)** — [this repository](../README.md)
